...
type PagerMessagesApiService service

/*
PagerMessagesApiService Create Internal Text Message
...
*/
func (a *PagerMessagesApiService) CreateInternalTextMessage(ctx context.Context, accountId string, extensionId string, body CreateInternalTextMessageRequest) (GetMessageInfoResponse, *http.Response, error) {
	var (
